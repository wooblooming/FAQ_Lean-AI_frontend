            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center">
                <div className="w-20 h-20 relative">
                  ...
                  <div className="relative flex items-center justify-center w-full h-full rounded-full bg-indigo-100">
              ...
              <div className="text-center">
                <h2 className="text-xl font-bold text-gray-800 mb-1">계정을 찾았습니다</h2>
              ...
              <div className="border border-indigo-200 rounded-xl overflow-hidden">
                <div className="border-b border-indigo-200 p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-xs text-indigo-500 font-medium">아이디</p>
                      <p className="text-lg font-bold text-gray-700">{userId || "정보가 없습니다"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-xs text-indigo-500 font-medium">가입일</p>
                      <p className="text-base font-medium text-gray-700">{formatDate(dateJoined)}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => router.push("/login")}
                className="w-full flex items-center justify-center bg-indigo-500 text-white py-3.5 px-4 rounded-xl shadow-md transition-all hover:shadow-lg"
              >
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="flex-1 px-4 py-3 rounded-xl border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-blue-200 transition-all outline-none"
