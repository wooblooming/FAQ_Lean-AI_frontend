...
const TabContent = ({ content }) => (
  <div className="bg-gray-800 rounded-lg shadow-md p-6 mt-4 max-h-[60vh] overflow-y-auto">
    {content.split('\n\n').map((paragraph, index) => (
...
const PrivacyTerms = () => {
  ...
  const privacyContent = `㈜린에이아이는 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하'정보통신망법')과 개인정보 보호법 등 국내 관련 법령을 준수합니다.

㈜린에이아이가 운영하는 '스마트FAQ 챗봇 플랫폼' (이하 "플랫폼"이라 한다)의 회원 가입을 신청하시는 이용자에게 개인정보의 수집항목 및 이용목적, 개인정보의 보유 및 이용기간에 대하여 아래와 같이 안내 드립니다.

1. 수집하는 개인정보 항목
- 회원가입 시 : 이름, 생년월일, 성별, 통신사명, 휴대전화번호, 동일인식별정보(CI), 중복가입확인정보(DI), 카드사명, 카드번호, 계좌은행, 계좌번호, 예금주명, 결제 승인번호
...
3.회원가입 계약의 성립시기는 “플랫폼”의 승낙이 회원에게 도달한 시점으로 합니다.
...
1.“플랫폼”은 회원으로부터 재화 등을 반환 받은 경우 3영업일 이내에 이미 지급받은 재화 등의 대금을 환급합니다.
이 경우 “플랫폼”이 회원에게 재화 등의 환급을 지연한 때에는 그 지연기간에 대하여 공정거래위원회가 정하여 고시하는 지연이자율을 곱하여 산정한 지연이자를 지급합니다.
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          ...
          <TabContent content={activeTab === 'privacy' ? privacyContent : termsContent} />
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 mt-2">서울특별시 관악구 봉천로 545, 2층(서울창업센터 관악)</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">빠른 링크</h4>
              <ul className="space-y-2">
                <li><Link href="/service-intro" className="text-gray-400 hover:text-white transition duration-300 flex items-center">
                  서비스 소개 <ExternalLink className="ml-1 h-4 w-4" />
                </Link></li>
                <li><Link href="/pricing" className="text-gray-400 hover:text-white transition duration-300 flex items-center">
                  요금제 <ExternalLink className="ml-1 h-4 w-4" />
                </Link></li>
                <li><Link href="/" className="text-gray-400 hover:text-white transition duration-300 flex items-center">
                  고객 지원 <ExternalLink className="ml-1 h-4 w-4" />
                </Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">문의하기</h4>
              <p className="text-gray-400 flex items-center"><ExternalLink className="mr-2 h-4 w-4" /> ch@lean-ai.com</p>
              <p className="text-gray-400 flex items-center mt-2"><ExternalLink className="mr-2 h-4 w-4" /> 02-6951-1510</p>
            </div>
          </div>
