    ...
    return (
        <div className="flex items-center space-x-3" style={{ fontFamily: 'NanumSquareBold' }}>
            ...
            <div>
                ...
                <span className="ml-2 text-gray-800" style={{ fontFamily: 'NanumSquareExtraBold' }}>{value || '-'}</span>
            </div>
        </div>
    )
}
                ...
                <div className='px-5 space-y-4'>
                    ...
                    <div name='storedData' className='space-y-2 ' >
                        ...
                        <div className="space-y-3 px-2">
                            ...
                            <InfoItem icon={<Clock className="h-5 w-5" />} label="운영 시간" value={selectedInstitution?.opening_hours} />
                            <InfoItem icon={<Phone className="h-5 w-5" />} label="대표 번호" value={selectedInstitution?.public_tel} />
                            <InfoItem icon={<MapPin className="h-5 w-5" />} label="주소" value={selectedInstitution?.public_address} />
                        </div>

                        {/* 소속 부서 입력 필드 */}
                        <div className="pt-4 border-t border-gray-200">
                            <label htmlFor="department" className=" font-medium  mb-2 block" style={{ fontFamily: 'NanumSquareExtraBold' }}>
                                소속 부서
                            </label>
