    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="mb-4">
          ...
          <div
            id="answer-1"
            className={`text-sm bg-gray-50 p-4 rounded-lg mt-2 ${
              openFAQ === 1 ? '' : 'hidden'
            }`}
          >
        ...
        <div className="mb-4">
          ...
          >
            ...
            수 있는 페이지로 이동합니다.데이터를 넣우신다음 무물에서 확인한 후 수정사항을
            반영해드립니다.
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          >
            매장 정보를 수정하려면 고객센터에 문의하거나 관리자 페이지에서
            직접 수정할 수 있습니다.
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          >
            서비스 관련 문의는 이메일(ch@lean-ai.com)로 연락해 주시면
            됩니다.
          </div>
        </div>
      </div>
