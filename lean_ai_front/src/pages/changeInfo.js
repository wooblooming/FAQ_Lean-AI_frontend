      ...
      <div className='flex flex-col justify-center items-center'>
        <div className="bg-white rounded-lg p-8 w-full max-w-md text-center mb-2 ">
          <div className="flex items-center justify-center mb-4">
            <Link href="/mainPageForPresident" className="text-gray-500 mr-4">
              <svg
        ...
        <div className="bg-sky-100 flex flex-col items-center text-center mb-4 min-w-72 px-2 relative">
        ...
        <div className="bg-sky-100 flex flex-col items-center text-center min-w-72 px-2 relative">
