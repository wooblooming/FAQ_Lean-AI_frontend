...
const storeIntroduce = () => {
  return (
    <div className="bg-white flex flex-col items-center min-h-screen overflow-y-auto relative">
      ...
      {/* 매장 기본정보 출력 */}
      <div className="bg-sky-100 flex flex-col items-center text-center mb-4 w-64 pt-3 px-2">
        <p className="mb-4 text-xl">영업 시간 : 9:00 ~ 18:00 <br /> 위치 : 서울특별시</p>
      </div>

      {/* 음식점일 경우 가격 출력 */}
      <div className="bg-sky-100 flex flex-col items-center text-center w-64 pt-3 px-2">
