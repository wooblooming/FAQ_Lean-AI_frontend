  ...
  return (
    <div className="min-h-screen p-6 font-sans bg-violet-50 space-y-3 flex flex-col items-center justify-center ">
      <div className="flex flex-col space-y-6 w-full md:w-1/2 items-start py-12 px-6 shadow-md rounded-lg bg-white">
        ...
        <div
          className="flex flex-col space-y-4 items-start text-left px-4"
            ...
            <div name="content" className="space-y-4 text-lg w-full ">
              ...
              >
                <div className="flex space-x-5 justify-even">
                  <span className="text-left w-20 whitespace-nowrap">
                    접수 번호:
                  </span>
                ...
                <div className="flex space-x-5 justify-even">
                  ...
                  <span className="text-left" style={{ width: "70%" }}>
              ...
              <div
                name="status"
                className="flex flex-col justify-center text-start space-y-2 w-full "
              >
                <h2
                  className="text-2xl"
                  style={{ fontFamily: "NanumSquareExtraBold" }}
                ...
                <div
                  name="status-process"
                  className="flex flex-col items-center space-y px-3 py-2 w-full"
                >
                  ...
                  <div className="mt-4 w-full h-2 bg-gray-200 rounded-full max-w-md">
                    <div
                      ...
                      style={{
                        width: `${
                          ((stages.indexOf(status) + 1) / stages.length) * 100
                        }%`,
                      }}
                    ></div>
                  </div>
