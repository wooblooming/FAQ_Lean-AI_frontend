                ...
                <div className='px-5  space-y-3'>
                    ...
                    <div className="flex items-center w-full space-x-4 ">
                        <div className="flex-grow relative">
                            ...
                            />
                            <label htmlFor="username" className="absolute left-2 top-1/2 transform -translate-y-1/2 text-red-500">*</label>
                    ...
                    <div className='flex flex-col space-y-1'>
                        {/* 비밀번호 확인 입력 */}
                        <label className="flex items-center text-gray-700 w-full" htmlFor="confirmPassword">
                            <div className="relative flex-grow">
                                <input type="password"
