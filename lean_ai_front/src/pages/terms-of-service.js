...
import ModalErrorMSG from "@/components/modal/modalErrorMSG"; // 에러 메시지 모달
...
const TermsOfServicePage = () => {
    ...
    **부칙**
    ...
    const handleAgree = (isAgreed) => {
        if (!isAgreed) {
            setErrorMessage("필수 약관에 동의해주셔야 서비스 이용이 가능합니다.");
    ...
    return (
        <div className="min-h-screen flex flex-col items-center p-6 bg-gray-50">
            <h1 className="text-3xl font-bold mb-4 text-indigo-700">이용약관 및 개인정보 수집 동의</h1>

            {/* 이용약관 */}
            <div className="max-w-2xl w-full bg-white p-6 rounded-lg shadow-md border">
                <h2 className="text-xl font-semibold mb-2">이용약관</h2>
                <div className="h-60 overflow-y-auto border rounded-md p-3 whitespace-pre-wrap bg-gray-100">
                    <p>{termsOfService}</p>
                </div>

                <h2 className="text-xl font-semibold mt-4 mb-2">개인정보 수집 및 이용 동의</h2>
                <div className="h-60 overflow-y-auto border rounded-md p-3 whitespace-pre-wrap bg-gray-100">
