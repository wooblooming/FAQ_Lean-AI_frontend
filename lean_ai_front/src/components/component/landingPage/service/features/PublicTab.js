...
const PublicTab = () => {
  ...
  const publicFeatures = [
    {
      ...
      description: "복잡한 양식 없이도 챗봇을 통해 민원을 접수하고 처리 현황도 쉽게 확인할 수 있어요.",
    },
    {
      icon: HelpCircle,
      title: "조례·법령 검색도 AI에게",
      description: "직접 찾던 규정이나 법률도 AI 챗봇이 빠르게 검색해줘서 공무원 업무가 훨씬 쉬워져요.",
    },
    {
      icon: Brain,
      title: "반복 민원은 자동 응대",
      description: "반복되는 단순 문의는 AI가 처리하고, 복잡한 민원은 담당자에게 자동으로 연결해줘요.",
    },
    {
      icon: FileText,
      title: "민원 데이터를 정책에 활용",
      description: "AI가 민원 데이터를 분석해 시민이 원하는 정책과 서비스 방향을 제안해줘요.",
    },
  ]
  ...
  return (
    <div className="space-y-8 sm:space-y-12">
      {/* 기능 카드 섹션 */}
      <FeatureCards features={publicFeatures} colorScheme="sky" title={<>공공기관을 위한<br />무물의 특별한 기능</>}  />
