  ...
  const storeFeatures = [
    {
      ...
      description:
        "복잡하게 설명할 필요 없어요. 질문만 입력하면, 고객 맞춤으로 딱 맞는 답변을 전달해줘요.",
    },
    {
      icon: HelpCircle,
      title: "자주 묻는 질문은 자동 응답!",
      description:
        "매번 똑같은 질문, 이제 그만! FAQ를 AI가 알아서 대응해줘서 응대 시간도 확 줄어요.",
    },
    {
      icon: Brain,
      title: "매장에 맞춘 똑똑한 챗봇",
      description:
        "우리 가게 특성에 맞게 학습된 AI가 정확하고 믿음직한 답변을 제공해줘요.",
    },
    {
      icon: FileText,
      title: "어떤 질문이 많은지도 한눈에",
      description:
        "반복되는 질문이나 자주 등장하는 이슈들을 자동으로 분석해줘서 운영에 도움돼요.",
    },
  ];
