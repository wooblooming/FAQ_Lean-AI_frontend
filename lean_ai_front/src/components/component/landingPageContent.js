...
const LandingPageContent = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-violet-50">
      {/* 네비게이션 바 */}
      <Nav isMobile={isMobile} isTablet={isTablet} isDesktop={isDesktop} isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn} />
      ...
      <motion.main
        ...
        variants={fadeInUp}
      >
        <ServiceSection isMobile={isMobile} isTablet={isTablet} isDesktop={isDesktop} />
      </motion.main>
