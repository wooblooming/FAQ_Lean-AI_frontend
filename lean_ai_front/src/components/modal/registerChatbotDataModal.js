...
export default function RegisterStoreData({ show, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-lg shadow-xl p-6 overflow-y-auto scroll-auto w-[95%] h-[70%] md:min-h-[600px] md:min-w-[400px] md:max-w-[25%]"
