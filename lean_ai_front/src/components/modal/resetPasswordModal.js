      ...
      <div className="bg-white p-6 rounded-lg shadow-lg space-y-4">
        ...
        <div className="flex justify-end mt-4">
          <button
            ...
            className="text-gray-500 px-3 py-2 font-semibold rounded-md hover:ring-2 ring-gray-400"
          >
            취소
          </button>
          <button
            onClick={handleResetPassword}
            className="text-indigo-500 px-3 py-2 font-semibold rounded-md hover:ring-2 ring-indigo-400"
          >
            비밀번호 재설정
          </button>
        </div>
