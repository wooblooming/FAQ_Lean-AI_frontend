...
const TermsOfServiceModal = ({ show, onClose, onAgree }) => {
  ...
  return (
    <div>
      <ModalText show={show} onClose={onClose} title="약관 동의">
        <div className="flex flex-col space-y-4">
          {/* 전체 동의 체크박스 */}
          <div
            className="p-4 bg-purple-50 rounded-lg cursor-pointer flex items-center space-x-3"
          ...
          >
            ...
            />
            <span className="font-medium text-lg">전체 동의하기</span>
          </div>
          ...
          <div className="border p-4">
            ...
            <div className="h-40 overflow-y-auto bg-gray-50 rounded-lg px-2 py-1">
